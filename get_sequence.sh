...
for chr_num in "${chr_num_array[@]}"; do
    ...
    bed_file="$HOME/genome_data/bed_and_fasta_file/utr_with_poly_A_bed_file/3UTR_poly_A_regions_chr${chr_num}.bed"
    # Define the name of the fasta file of the chromosome
    chr_fasta_file="$HOME/genome_data/bed_and_fasta_file/chr_fasta_file/chr${chr_num}.fa"
    # Define the sequence_output name
    sequence_output="$HOME/genome_data/bed_and_fasta_file/utr_with_poly_A_output/3UTR_with_poly_A_sequences_DNA/3UTR_with_poly_A_sequences_on_chr${chr_num}.fa"

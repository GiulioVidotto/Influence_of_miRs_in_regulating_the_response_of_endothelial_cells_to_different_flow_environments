...
## read Giulio's excel and check 

Did both first file and second file. Second was obviuosly wrong 

```{r pressure, echo=FALSE}

# 
dat = read_excel("~/data/Steve_White/results/Giulio/2026/IPA_input/excel_proteomics_first file.xlsx", sheet = 1 )
...
Either remove (set to NA) values for FC and pval where FC is 100 or 0.01 (output file "proteomics_3contrasts_log2_table_rm100.txt")
or leave them in ("proteomics_3contrasts_log2_table_with100.txt")
...
#write_tsv(dat, file =  file.path("~/data/Steve_White/results/Giulio/2026/IPA_input/", outfile))
